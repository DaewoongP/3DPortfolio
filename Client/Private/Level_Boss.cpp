...
HRESULT CLevel_Boss::Ready_Layer_UI(const _tchar* pLayerTag)
{
	...
	if (FAILED(pGameInstance->Add_GameObject(LEVEL_BOSS, TEXT("Prototype_GameObject_Boss_Hp"), pLayerTag, TEXT("GameObject_Boss_Hp"))))
	{
		MSG_BOX("Failed Add_GameObject : (GameObject_Boss_Hp)");
		return E_FAIL;
	}
	...
	if (FAILED(pGameInstance->Add_GameObject(LEVEL_BOSS, TEXT("Prototype_GameObject_UI_Dead"), pLayerTag, TEXT("GameObject_UI_Dead"))))
	{
		MSG_BOX("Failed Add_GameObject : (GameObject_UI_Dead)");
		return E_FAIL;
	}

	if (FAILED(pGameInstance->Add_GameObject(LEVEL_BOSS, TEXT("Prototype_GameObject_MainSlot"), pLayerTag, TEXT("GameObject_MainSlot"))))
	{
		MSG_BOX("Failed Add_GameObject : (GameObject_MainSlot)");
		return E_FAIL;
	}

	if (FAILED(pGameInstance->Add_GameObject(LEVEL_BOSS, TEXT("Prototype_GameObject_BlinkTarget"), pLayerTag, TEXT("GameObject_BlinkTarget"))))
	{
