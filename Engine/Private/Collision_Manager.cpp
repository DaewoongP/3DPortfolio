...
void CCollision_Manager::Tick()
{
	...
	Collision(COLLISIONDESC::COLTYPE_PLAYER, COLLISIONDESC::COLTYPE_KNOCKBACK);
	Collision(COLLISIONDESC::COLTYPE_PLAYERWEAPON, COLLISIONDESC::COLTYPE_ENEMY);
	...
	Collision(COLLISIONDESC::COLTYPE_PLAYERVISION, COLLISIONDESC::COLTYPE_ENEMY);
	Collision(COLLISIONDESC::COLTYPE_PLAYERVISION, COLLISIONDESC::COLTYPE_ENEMYWEAPON);
	Collision(COLLISIONDESC::COLTYPE_PLAYERVISION, COLLISIONDESC::COLTYPE_PARRYING);
	Collision(COLLISIONDESC::COLTYPE_ENEMY, COLLISIONDESC::COLTYPE_ENEMY);

	Collision(COLLISIONDESC::COLTYPE_PLAYER, COLLISIONDESC::COLTYPE_TRIGGER);
