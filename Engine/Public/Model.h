...
public:
	...
	void	Play_Animation(_double dTimeDelta, _bool bPassLerp = false, _double dLerpTime = 0.1);
	_bool	Invalidate_AnimationCamera(class CCamera* pCamera, class CTransform* pPlayerTransform, _double dTimeDelta);
