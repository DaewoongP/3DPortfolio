...
public:
	virtual HRESULT Initialize_Prototype(_uint iTrailNum, _float fSizeX);
...
public:
	static CVIBuffer_Rect_Trail* Create(ID3D11Device * pDevice, ID3D11DeviceContext * pContext, _uint iTrailNum, _float fSizeX);
