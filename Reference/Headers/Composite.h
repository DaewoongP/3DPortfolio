...
public:
	...
	HRESULT		Add_Part(_uint iLevelIndex, const _tchar* pPrototypeTag, const _tchar* pLayerTag, const _tchar* pObjectTag, _Inout_ class CGameObject** ppOut, void* pArg = nullptr);
